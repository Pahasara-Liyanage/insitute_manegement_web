          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box" style="background: linear-gradient(135deg, #36d1c4 0%, #5b86e5 100%); color: #fff;">
                    <div class="inner">
                        <p>Subjects</p>
                        <h3>{{ $subjectCount }}</h3>
                    ...
                    >
                        ...
                        <path d="M4 19.5A2.5 2.5 0 0 0 6.5 22H20a1 1 0 0 0 1-1V6a2 2 0 0 0-2-2H6.5A2.5 2.5 0 0 0 4 6.5v13zm2.5.5A.5.5 0 0 1 4 19.5V6.5A.5.5 0 0 1 6.5 6H19v14H6.5z"/>
                        <rect x="8" y="8" width="7" height="1.5" rx=".5"/>
                        <rect x="8" y="11" width="5" height="1.5" rx=".5"/>
                    </svg>
                    <a
                        ...
                        style="color: #fff;"
                    >
                        View Subjects <i class="bi bi-arrow-right-circle"></i>
                    </a>
                </div>     <!--end::Small Box Widget 1-->     </div>     <!--end::Col-->
              <div class="col-lg-3 col-6">
